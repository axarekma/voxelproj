                              ...
                              int v0, int v1, int v2, int p0, int p1, int p2)
{
    ...
    if (vecy > vecx)
    {
        ...
        {
            output[index_proj] += order_z2::sp_ray_sum_stride1(tex_vol, zi, ray_vec, intersect_box, pwi_args, Nvol);
            // return 0.0f;
        }
    }
    else
    {
        ...
        if (RectangleIntersectVec(ray0, v_norm, extended_box, intersect_box))
        {
            output[index_proj] += order_z2::sp_ray_sum_stride0(tex_vol, zi, ray_vec, intersect_box, pwi_args, Nvol);
            // return 0.0f;
        }
    }
    return;
